...
- **Proven High-Stakes Experience:**
  ...
  3. **Secretary** at CPC UPI (Jan 2025 - Jan 2026) - Trusted with administrative and operational responsibilities for the university's competitive programming club
  4. **Head of Sub Division** at Dinamik 20 (Jun 2025 - Dec 2025) - Led opening/closing ceremony team
...
- Academic Performance: GPA 3.82/4.00 (Top performer)
...
- **If asked "Why hire her?":** Fast learner (23 credits in Sem 5), proven track record (BUMN + organizational leadership), GPA 3.82
...
A: "Absolutely! Hafsah pernah handle project BUMN (PT Rekayasa Industri) dan dipercaya jadi Sekertaris di organisasi CPC UPI. Track record-nya solid! ✨"
...
export async function POST(req: Request) {
  try {
    ...
    const fallbackResponses: { [key: string]: string } = {
      ...
      'gpa|nilai|ipk': 'Her GPA is 3.82 out of 4.00! She achieved a perfect 4.00 in Semester 4, which shows her academic excellence. 📚✨',
      ...
      'trust|reliable|bisa dipercaya|trustworthy': 'Absolutely! She\'s trusted as Secretary at CPC UPI and Head of Division at Dinamik 20. Her BUMN project experience and leadership roles prove her reliability. ✨',
      ...
      'hire|recruit|hiring|job|employment': 'Hafsah is the perfect hire! She has proven commercial experience (BUMN, Xtrahera), strong GPA (3.82), AI/ML expertise, full-stack capabilities, and proven leadership. 🌟',
      ...
      'why hire|why choose|why her|best': 'Why hire Hafsah? She combines solid academics (3.82 GPA), real-world commercial experience (BUMN, Xtrahera), diverse skill set (full-stack + AI), proven mentorship, AND proven leadership. She\'s a complete package! 💎',
      ...
      'summary|about hafsah|tell me about|who is|introduce': 'Hafsah Hamidah is a 21-year-old Computer Science student (Sem 6, UPI) with a 3.82 GPA and proven commercial experience. She\'s a full-stack developer at Xtrahera, worked on BUMN projects, and has 17+ projects including AI/ML expertise. She\'s available for internship, freelance, and remote work NOW! 🚀✨',
      ...
      'overview|big picture|entire story': 'Here\'s Hafsah\'s story: 21-year-old CS student → Full-Stack Dev at Xtrahera → BUMN corporate project → AI/ML specialist → Mentored 70+ students → Led teams → GPA 3.82 → 17+ projects → Now seeking internship/freelance. She\'s ready! 📖',
      ...
      'background|history|journey|career path': 'Career journey: Started with academic excellence (3.82 GPA), gained teaching experience (70+ students), secured BUMN commercial project, landed full-stack role at Xtrahera, developed 17+ real projects, and held 4 leadership positions! 📈',
      'why her|pick her|choose|select': 'Pick Hafsah because: ✓ Proven commercial work (BUMN, Xtrahera) ✓ Real deployed projects ✓ AI/ML expertise (95% accuracy) ✓ Full-stack capabilities ✓ 3.82 GPA ✓ Leadership & mentorship ✓ Fast learner ✓ Team player. She\'s investment-ready! 💎',
      ...
      'education background|school|study': 'She studied Computer Science at Universitas Pendidikan Indonesia (UPI) and is currently in Semester 6 (3rd year). Academic excellence with 3.82 GPA and perfect 4.00 in Semester 4! 🎓',
