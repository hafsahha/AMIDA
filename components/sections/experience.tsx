...
const experiences = [
  {
    ...
    period: "2024-Present",
    desc: "Architecting scalable solutions and leading technical implementations for various enterprise projects.",
  ...
  },
  {
    ...
    period: "Mar-May 2025",
    desc: "Optimized user interfaces for industrial data management systems, improving reporting efficiency by 40%.",
    icon: <Briefcase className="size-5" />,
  },
  {
    role: "Secretary",
    company: "Competitive Programming Club UPI",
    period: "2024-2025",
    desc: "Managed club operations and coordinated training sessions for 100+ active members.",
  ...
  },
  {
    ...
    company: "Dinamik 20",
    period: "2024",
    desc: "Led a team of developers and designers for the annual technology festival at UPI.",
    icon: <Users className="size-5" />,
  },
]
