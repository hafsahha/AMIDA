...
const projectsData = [
  // Featured / High-Tech (AI, Data & IoT)
  {
    ...
    solution: "Shifted from classification to detection using YOLOv8 Nano, allowing the app to localize multiple motifs in a single frame regardless of the object's shape. Quantized the model to INT8 and integrated into Flutter using tflite_flutter.",
    features: ["Real-time Object Detection @ 15+ FPS", "INT8 Model Quantization", "Geometrically Augmented Dataset", "Mobile Optimization"],
  },
  {
    id: "pahamsaham",
    title: "PahamSaham",
    category: "AI & Data",
    role: "Data Engineer",
    tech: ["Apache Airflow", "Docker", "MongoDB", "Pandas", "Python"],
    tags: ["Data Engineering", "ETL", "Docker", "MongoDB"],
    ...
    problem: "Manual stock data analysis is inefficient. Needed a centralized, automated source of truth.",
    solution: "Built a containerized ETL pipeline using Apache Airflow and Docker. Developed Python scrapers to pull IDX data, cleaned with Pandas, and stored in MongoDB for flexible unstructured sentiment data handling.",
    features: ["Containerized Orchestration", "Automated DAGs", "Real-time Data Ingestion", "Sentiment Analysis"],
  },
  {
    id: "pantanizz",
    title: "PantaniZz",
    category: "IoT",
    role: "IoT Engineer",
    tech: ["Golang", "MQTT", "ESP32", "Flutter", "PostgreSQL"],
    tags: ["IoT", "Golang", "MQTT"],
    image: "/iot-hydroponic-monitoring-dashboard.jpg",
    gridSpan: "normal",
    parallaxSpeed: 0.4,
    context: "Smart Agriculture initiative focusing on hardware-software integration",
    problem: "Handling high-frequency data streams from sensors (pH, TDS, Temp) and ensuring low-latency control of actuators.",
    solution: "Used MQTT instead of HTTP for lightweight, real-time communication. Built backend with Golang, utilizing Go Routines to handle concurrent sensor streams efficiently.",
    features: ["Real-time WebSocket Charts", "Concurrent Go Routines", "MQTT Protocol", "Hardware Integration"],
  },
  {
    id: "ailearn",
