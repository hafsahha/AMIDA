    ...
    <>
      ...
      <div className="hidden md:block">
        ...
        <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50">
          <div className="px-6 py-3 rounded-full border border-foreground/10 bg-[#fdfbf7]/95 dark:bg-[#050a0a]/95 md:glass-panel md:backdrop-blur-xl md:bg-background/30 shadow-2xl transition-all duration-300 hover:px-8 hover:shadow-[0_0_40px_rgba(0,0,0,0.2)]">
      ...
      <div className="md:hidden">
        ...
        <div className="fixed top-6 right-6 z-50 flex items-center gap-2">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="bottom" className="h-[60vh] rounded-t-3xl border-t bg-[#fdfbf7]/95 dark:bg-[#050a0a]/95 md:glass-panel md:backdrop-blur-xl">
